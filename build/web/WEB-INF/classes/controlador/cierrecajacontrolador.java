...
import modelo.cierrecajamodelo;

/**
 *
 * @author User
 */
@WebServlet(name = "cierrecajacontrolador", urlPatterns = {"/cierrecajacontrolador"})
public class cierrecajacontrolador extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("Agregar")) {
            ...
            modelo.setCodigo(request.getParameter("txtcodigo"));
             modelo.setCiefecha(request.getParameter("txtciefecha"));
              modelo.setCiemonto(request.getParameter("txtciemonto"));
               modelo.setApeid(request.getParameter("txtapeid"));
            ...
            try {
                ...
                Logger.getLogger(cierrecajacontrolador.class.getName()).log(Level.SEVERE, null, ex);
            }
            //SE ESPECIFICA QUE PAGINA DEBE MOSTRAR EN LA VARIABLE ACCESO
            acceso = "cierrecaja.jsp";
