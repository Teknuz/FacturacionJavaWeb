<%@ page import="modelo.cobromodelover" %>
    ...
    <main class="container mt-5">
        <div id="inicio">
            <div class="bloque-inicio2">
                <h1 class="mb-4">Formulario Cobros</h1>
                <form action="cobrocontrolador" method="POST">
                    
                    <div class = "buttons">
                        <button type="submit" name="accion" value="add" class="btn btn-primary me-3">AGREGAR UN NUEVO COBRO</button>
                    ...
                    <table class="table mt-4">
                        ...
                        <tbody>
                            <% 
                                ...
                                List<cobromodelover> list = modelo.listarcobros();
                                Iterator<cobromodelover> iter = list.iterator();
                                cobromodelover m = null;
                                while (iter.hasNext()) {
                                    m = iter.next();
                            %>
                            <tr>
