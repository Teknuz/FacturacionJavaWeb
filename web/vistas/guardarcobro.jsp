...
<body>
    ...
    <form action="cobrocontrolador" method="post">
                ...
                <table border="0">
                    <tbody>
                        <tr>
                            ...
                            <td><button type="button" name="btnbuscarcli" onclick="mostrarModal()">BUSCAR</button></td>
                        </tr>
                        <tr>
                            <td>NOMBRE</td>
                        ...
                        <table border="1" id="mitabla">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button type="button" onclick="obtenerFilacliente(this)">SELECCIONAR</button></td>
                                </tr>
                                <% } %>
                            </tbody>
                        </table>
        ...
        <div class="container3">
            <div class="window2">
                <button type="submit" name="accion" value="guardarcobro">GUARDAR</button>
            </div>
        </div>
    </form>
