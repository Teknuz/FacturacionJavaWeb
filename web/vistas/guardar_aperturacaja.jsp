...
<html>
    ...
    <body>
        ...
        <form action="../aperturacajacontrolador" method="post">
            ...
            <h1> FECHA</h1> <input type="text" name="txtfecha">
            <h1> MONTO </h1><input type="number"  name="txtmonto">
            <h1> ESTADO</h1> <input type="text" name="txtestado">
            <h1> USUARIO </h1><input type="text" name="txtusuario">
