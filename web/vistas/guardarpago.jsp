...
<body>
    ...
    <form action="pagocontrolador" method="post">
                ...
                <table border="0">
                    <tbody>
                        <tr>
                            ...
                            <td><button type="button" name="btnbuscarprov" onclick="mostrarModal()">BUSCAR</button></td>
                        </tr>
                        <tr>
                            <td>NOMBRE</td>
                        ...
                        <table border="1" id="mitabla">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button type="button" onclick="obtenerFilaproveedor(this)">SELECCIONAR</button></td>
                                </tr>
                                <% } %>
                            </tbody>
                        </table>
        ...
        <div class="container3">
            <div class="window2">
                <button type="submit" name="accion" value="guardarpago">GUARDAR</button>
            </div>
        </div>
    </form>
