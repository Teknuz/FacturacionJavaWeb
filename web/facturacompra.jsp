    ...
    <main class="container mt-5">
        <div id="inicio">
            <div class="bloque-inicio2">
                <h1 class="mb-4">Formulario Compra</h1>
                    ...
                    <table class="table mt-4">
                        ...
                        <tbody>
                            <% 
                                ...
                                List<facturacompramodelo> list = modelo.listarfacturas();
                                Iterator<facturacompramodelo> iter = list.iterator();
                                facturacompramodelo m = null;
                                while (iter.hasNext()) {
                                    m = iter.next();
                            %>
                            <tr>
