    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action != null) {
            if (action.equalsIgnoreCase("home")) {
                ...
                modelo.setCodigo(request.getParameter("txtnumero"));
                ...
                if (comprasSeleccionadas != null) {
                    for (String idcompra : comprasSeleccionadas) {
                        // Obtener el monto correspondiente a la factura seleccionada
                        String monto = request.getParameter("monto_" + idcompra);
                        // Guardar el detalle del cobro
                        modelo.guardardetalle(idcompra,request.getParameter("txtnumero"), monto);
                    }
                }
                acceso = "pagos.jsp";
                ...
                for (pagomodelo compra : pagosPendientes) {
                    ...
                    out.println("<td><input type='checkbox' name='comprasSeleccionadas' value='" + compra.getCodigo() + "'></td>");
                    out.println("</tr>");
                }
                return;
